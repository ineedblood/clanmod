...
void ForceProtect( gentity_t *self )
{
	...
	if (self->client->ps.fd.forcePowersActive & (1 << FP_RAGE) && !(cm_forcecombo.integer == 0))
	{
		WP_ForcePowerStop( self, FP_RAGE );
	}
	if (self->client->ps.fd.forcePowersActive & (1 << FP_ABSORB) && !(cm_forcecombo.integer == 0))
	{
...
void ForceAbsorb( gentity_t *self )
{
	...
	if (self->client->ps.fd.forcePowersActive & (1 << FP_PROTECT)  && !(cm_forcecombo.integer == 0))
	{
		WP_ForcePowerStop( self, FP_PROTECT );
	}
